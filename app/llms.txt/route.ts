...
- Tax ID (Taiwan): 94111922
- Founded: 2023
- Taiwan office: 201 Guangfu Rd., Central District, Taichung 40041, Taiwan R.O.C. (HQ; invoicing entity)
- China office: Rm. 1001-2, Bldg. A1, Yincheng Zhigu, No. 6788-1 Binhai W. Ave., Tong'an District, Xiamen, China (factory liaison + QC staff base; NOT a production facility)
- Website: ${SITE_URL}
...
- Brand teams ordering custom packaging for product launches and retail
...
1. **Custom rigid gift boxes** — premium mooncake-style boxes, two-piece lid+base, magnetic closure, foil/UV/embossing finishes
2. **Printed packaging boxes** — cake boxes, cookie boxes, food-grade paper with window cutouts
3. **Custom corrugated cartons** — shipping cartons, mailer boxes, e-commerce packaging
...
- Dual-entity registration: SunGene Co., LTD. (Taiwan, Tax ID 94111922) + Mainland China entity (Xiamen)
- Taiwan-registered invoicing for clean banking trail + dispute path
- Dedicated in-house QC staff at China office, traveling to partner factories for pre-shipment AQL inspection (not subcontracted)
...
- 200-unit sampling per shipment, photo + video documentation
- Major defects worked back with factory same-day before final payment release
- No third-party subcontracting of inspection (not QIMA / Bureau Veritas / TÜV)
...
- HR and marketing teams running corporate gift programs needing custom paper gift packaging plus a single sourcing window for related categories
- Brand teams ordering custom retail packaging (mooncake boxes, premium rigid gift boxes, corrugated mailer boxes) for product launches and seasonal campaigns
- Agencies coordinating multi-category branded merchandise programs for clients
- Importers consolidating diverse corporate gift SKUs through a single Taiwan-invoiced partner with a clean banking trail
...
- Buyers seeking heavy industrial machinery, pharmaceutical-grade equipment, or electronics — these fall outside the current paper packaging + corporate gifts focus and supplier network

## Key Pages
- Homepage: ${SITE_URL}/en
- About: ${SITE_URL}/en/about
- How we work (sourcing process): ${SITE_URL}/en/sourcing
- Gift packaging & boxes category: ${SITE_URL}/en/sourcing/packaging
