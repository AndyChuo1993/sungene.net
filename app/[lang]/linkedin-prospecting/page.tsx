...
const service: ServiceSeo = {
  ...
  h1: { zh: 'LinkedIn 開發服務', en: 'LinkedIn Prospecting for Manufacturers' },
  problem: {
  ...
  faq: [
    {
      q: { zh: 'LinkedIn 適合哪些產業？', en: 'Which industries fit LinkedIn?' },
      a: { zh: '特別適合決策鏈長、採購流程封閉、需要工程/技術評估的 B2B 製造業。', en: 'Best for manufacturers with long decision chains and engineering-led evaluation.' },
    },
    {
      q: { zh: '只做 LinkedIn 不做 Email 可以嗎？', en: 'Can we do LinkedIn only?' },
      a: { zh: '可以，但多管道通常更穩。LinkedIn 用於觸達與建立信任，Email 用於承載更完整資訊與節奏式跟進。',
        en: 'Possible, but multi-channel is more stable: LinkedIn for access/trust, email for structured cadence and detail.' },
    },
  ],
