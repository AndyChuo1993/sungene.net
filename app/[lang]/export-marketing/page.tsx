...
const service: ServiceSeo = {
  ...
  h1: { cn: '出口行銷服務', zh: '出口行銷服務', en: 'Export Marketing for Manufacturers' },
  problem: {
    cn: ['你的服務頁太像銷售頁：缺清楚的說明、清單、指南與資料，買家看完不容易理解差異與下一步。', '關鍵字覆蓋太少：只吃到少數詞，缺乏長尾流量（how to / tools / checklist）。', '內部連結規則不清楚，文章與服務、案例、資源磁鐵之間沒有形成集群。'],
  ...
  solution: {
    cn: ['我們用「頁型架構 + 內容模板 + Schema + 內鏈規則」把網站做成可持續獲客的系統，而不是一次性的文章堆疊。', '內容用清楚的結構（定義 / 方法 / 工具 / 步驟 / 清單 / FAQ）讓買家更快看懂、比較並採取行動。'],
  ...
  whatIs: {
    cn: ['出口行銷是以海外買家搜尋意圖為核心，透過內容、落地頁、結構化資料與內部連結，把自然流量轉成可追蹤的詢價。'],
  ...
  howWorks: {
    cn: ['我們會先定義你要吸引的買家輪廓與關鍵字群，接著建立可擴展的頁面結構，最後用內容生產節奏持續擴大長尾流量。'],
  ...
  process: {
    cn: ['關鍵字與頁型規劃：服務/市場/產業/文章/資源磁鐵。', '建立可轉化的內容模板：TOC、FAQ、案例與 CTA。', '上線結構化資料：Article/FAQ/Breadcrumb/Organization。', '內部連結規則化：文章→服務→案例→資源磁鐵。', '每週迭代：2 篇文章/週，並回補舊文與內鏈。'],
  ...
  tools: {
    cn: ['關鍵字研究：以主旨群集（Topic Cluster）拆解成服務/方法/成果/產業/市場。', '內容模板：定義/方法/工具/步驟/清單/FAQ。', '技術 SEO：sitemap、canonical、hreflang、Schema（FAQ/Article/Breadcrumb）。'],
  ...
  checklist: {
    cn: ['完成 1 個核心服務頁（含 FAQ schema + 內鏈）。', '完成 1 篇權威文章（3000 字以上）並加 TOC 與 Checklist。', '每篇文章至少連到：服務 + 案例 + 資源磁鐵。', '每週固定產出與回補舊文，維持節奏。'],
  ...
  industries: {
    cn: ['機械設備', '電子零元件', '塑膠射出/製品', '化工材料', '醫療器材', '汽車零件', '工業設備'],
  ...
  caseStudy: {
    title: { cn: '從內容架構切入，讓詢價變穩定', zh: '從內容架構切入，讓詢價變穩定', en: 'From content architecture to stable inbound inquiries' },
    desc: {
      cn: '以服務頁＋市場頁＋文章群集建立權威，再用資源磁鐵提升轉化，逐步把搜尋流量變成可跟進的 leads。',
  ...
  faq: [
    {
      q: { cn: '內容架構是什麼？', zh: '內容架構是什麼？', en: 'What is content architecture?' },
      a: { cn: '內容架構是把買家常問的問題，用一致的段落與順序說清楚（定義、適用情境、流程、交付、FAQ），讓人一眼看懂差異並知道下一步。', zh: '內容架構是把買家常問的問題，用一致的段落與順序說清楚（定義、適用情境、流程、交付、FAQ），讓人一眼看懂差異並知道下一步。', en: 'Content architecture organizes buyer questions into a consistent structure (definition, fit, process, deliverables, FAQ) so visitors can compare and take action faster.' },
    },
    {
      q: { cn: '多久能看到流量？', zh: '多久能看到流量？', en: 'How soon will we see traffic?' },
      a: { cn: '通常 8–12 週會看到長尾曝光提升；6–12 個月在穩定更新節奏下，才會有明顯的流量與詢價增長。', zh: '通常 8–12 週會看到長尾曝光提升；6–12 個月在穩定更新節奏下，才會有明顯的流量與詢價增長。', en: 'Expect long-tail impressions in 8–12 weeks; meaningful traffic and inquiries typically take 6–12 months with consistent shipping.' },
    },
  ],
  ctaTitle: { cn: '把網站做成 inbound 產生器', zh: '把網站做成 inbound 產生器', en: 'Turn your site into an inbound machine' },
  ctaDesc: { cn: '從頁面結構、文章群集到 schema 與內鏈，我們幫你把增長流程做成可持續的系統。', zh: '從頁面結構、文章群集到 schema 與內鏈，我們幫你把增長流程做成可持續的系統。', en: 'From architecture and clusters to schema and internal links, we turn growth into a repeatable system.' },
  relatedLinks: [
    { label: { cn: '外銷資源：How to find overseas buyers', zh: '外銷資源：How to find overseas buyers', en: 'Guide: How to find overseas buyers' }, href: '/blog/how-to-find-overseas-buyers' },
    { label: { cn: '外銷客戶開發（核心服務）', zh: '外銷客戶開發（核心服務）', en: 'Export Lead Generation (Core)' }, href: '/services/export-lead-generation' },
    { label: { cn: '成功案例（證據）', zh: '成功案例（證據）', en: 'Case Studies (Proof)' }, href: '/case-studies' },
