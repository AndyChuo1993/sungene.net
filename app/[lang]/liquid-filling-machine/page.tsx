...
export default async function LiquidFillingMachinePage({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const jsonLd = {
    ...
    name: t.title,
    description: descriptions[lang] || descriptions.en,
    url: `https://sungene.net/${lang}/liquid-filling-machine`,
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Liquid Filling Machine', item: `https://sungene.net/${lang}/liquid-filling-machine` },
    ],
  }
