...
const service: ServiceSeo = {
  ...
  title: {
    cn: '海外買家名單（Overseas Buyer Lists）｜可直接使用的寄信名單與開信名單',
    zh: '海外買家名單（Overseas Buyer Lists）｜可直接使用的寄信名單與開信名單',
    en: 'Overseas Buyer Lists | Ready-to-use Prospect Lists for Export',
  },
  description: {
    cn: '交付可直接使用的海外買家名單：寄信名單與開信名單（Excel），包含公司、決策人、職位、Email、LinkedIn、公司網站。',
  ...
  h1: { cn: '海外買家名單交付', zh: '海外買家名單交付', en: 'Overseas Buyer Lists (Deliverable)' },
  problem: {
    cn: ['名單品質不穩，寄了沒回還跳退。', '沒有決策人資料，只能寄到一般信箱。', '名單缺分層與標註，無法支援後續跟進。'],
  ...
  solution: {
    cn: ['我們以 ICP 與買家角色為核心，建立可驗證的買家資料函式庫並以 Excel 交付。', '名單支援後續的 cold email/LinkedIn 節奏與回覆分類別。'],
  ...
  whatIs: {
    cn: ['Overseas Buyer Lists 是外銷開發的核心資產：可投遞、可追蹤、可分層的海外買家名單。'],
  ...
  howWorks: {
    cn: ['我們先定義你要找的買家角色與市場，接著用多來源蒐集與驗證建立資料函式庫，再把名單分層交付。'],
  ...
  process: {
    cn: ['定義 ICP 與買家角色。', '多來源蒐集公司與決策人。', '驗證 Email/LinkedIn 並去重。', '分層標註（市場/角色/優先序）。', 'Excel 交付（寄信名單 + 開信名單）。'],
  ...
  tools: {
    cn: ['Google/LinkedIn/產業目錄/展會名單。', '公司網站與職位驗證。', 'Email 驗證流程與去重。'],
  ...
  checklist: {
    cn: ['名單欄位齊全（公司/決策人/職位/Email/LinkedIn/官網）。', 'Email 驗證與去重完成。', '分層標註（市場/角色/優先序）。', '可直接用於後續節奏式跟進。'],
  ...
  caseStudy: {
    title: { cn: '五金工具：首月建立 500+ 目標名單', zh: '五金工具：首月建立 500+ 目標名單', en: 'Hardware: built 500+ targets in month one' },
    desc: { cn: '名單品質到位後，回覆與詢價更容易穩定累積。', zh: '名單品質到位後，回覆與詢價更容易穩定累積。', en: 'List quality enabled more stable replies and inquiries.' },
    link: '/case-studies/hardware',
  },
  faq: [
    { q: { cn: '名單能否指定市場與買家角色？', zh: '名單能否指定市場與買家角色？', en: 'Can we specify markets and buyer roles?' }, a: { cn: '可以。名單會依你產品與目標市場定義 ICP 與角色後建置。', zh: '可以。名單會依你產品與目標市場定義 ICP 與角色後建置。', en: 'Yes. Lists are built based on your ICP by market and role.' } },
    { q: { cn: '名單交付後你們也能協助開發嗎？', zh: '名單交付後你們也能協助開發嗎？', en: 'Can you run outreach after list delivery?' }, a: { cn: '可以，後續可銜接 Cold Email/LinkedIn 或核心服務的外銷客戶開發。', zh: '可以，後續可銜接 Cold Email/LinkedIn 或核心服務的外銷客戶開發。', en: 'Yes. You can continue with cold email/LinkedIn or the core export lead gen service.' } },
  ],
  ctaTitle: { cn: '取得你的海外買家名單', zh: '取得你的海外買家名單', en: 'Get Your Overseas Buyer List' },
  ctaDesc: { cn: '提交產品與市場，我們回覆名單來源、建置方式與交付範圍。', zh: '提交產品與市場，我們回覆名單來源、建置方式與交付範圍。', en: 'Submit your product and markets. We’ll reply with sources, build plan, and scope.' },
  relatedLinks: [
...
export async function generateMetadata({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  return {
    ...
    alternates: { canonical: `/${lang}/overseas-buyer-lists`, languages: { 'zh-CN': '/cn/overseas-buyer-lists', zh: '/zh/overseas-buyer-lists', en: '/en/overseas-buyer-lists', 'x-default': '/en/overseas-buyer-lists' } },
