...
const service: ServiceSeo = {
  ...
  h1: { cn: '市場切入策略', zh: '市場切入策略', en: 'Market Entry Strategy for Manufacturers' },
  problem: {
    cn: ['市場選太大：不知道先做哪一國、哪一個買家角色，資源被分散。', '沒有通路結構理解：直銷、經銷、代理、整合商混在一起，訊息無法對準。', '沒有可驗證假設：開發一段時間後無法判斷是名單問題、訊息問題、或市場選錯。'],
  ...
  solution: {
    cn: ['我們用「市場分層 → 買家角色 → 通路地圖 → 切入假設 → 測試節奏」建立一份可執行的市場切入策略。', '策略會對應到後續的名單建置、訊息框架與跟進節奏，讓你能快速驗證與迭代。'],
  ...
  whatIs: {
    cn: ['Market Entry Strategy 是把「市場選擇」變成可測試、可迭代的假設：先選最有機會的市場與角色，再用最小成本的開發測試來驗證。'],
  ...
  howWorks: {
    cn: ['製造業常見問題不是沒有好產品，而是沒有優先序：先做哪個市場、先找哪種買家、用什麼通路切入。清楚的分層能大幅提高開發效率。'],
  ...
  process: {
    cn: ['蒐集產品與現況：規格、應用、差異點、交期、MOQ、現有客群。', '市場分層：優先/次要市場與競品對照。', '買家角色拆解：Importer/Distributor/Brand/Factory/Integrator。', '通路地圖與 Offer：合作條件、證據素材與 CTA。', '測試節奏：用小規模名單 + 訊息框架快速驗證。'],
  ...
  tools: {
    cn: ['市場資料：進出口資料、產業報告、競品通路觀察。', '通路研究：協會/展會/目錄/LinkedIn。', '驗證方法：小規模測試（名單 + 訊息 + 跟進）。'],
  ...
  checklist: {
    cn: ['選出 1–2 個優先市場與明確的買家角色。', '寫出一個可計算的 Offer（差異點 + 證據 + CTA）。', '建立 100 家測試名單並完成驗證。', '跑 2 週測試並用資料決定下一步。'],
  ...
  industries: {
    cn: ['機械設備', '電子零元件', '五金工具', '化工材料', '套件材/材料'],
    zh: ['機械設備', '電子零元件', '五金工具', '化工材料', '套件材/材料'],
    en: ['Machinery', 'Electronics', 'Hardware Tools', 'Chemicals', 'Packaging/Materials'],
  },
  caseStudy: {
    title: { cn: '從市場分層到通路落地：安排 15 場會議、簽約 3 家代理', zh: '從市場分層到通路落地：安排 15 場會議、簽約 3 家代理', en: 'From segmentation to channel execution: 15 meetings, 3 agents signed' },
    desc: { cn: '以市場分層與通路角色拆解，讓會議邀約與條件談判更有效率。', zh: '以市場分層與通路角色拆解，讓會議邀約與條件談判更有效率。', en: 'Segmentation and role clarity made meeting-setting and terms negotiation more effective.' },
    link: '/case-studies/machinery',
  },
  faq: [
    {
      q: { cn: '怎麼知道市場選對了？', zh: '怎麼知道市場選對了？', en: 'How do we know the market is right?' },
      a: { cn: '用小規模名單 + 訊息 + 跟進做 2 週測試，以回覆與需求訊號判斷是否放大。', zh: '用小規模名單 + 訊息 + 跟進做 2 週測試，以回覆與需求訊號判斷是否放大。', en: 'Run a 2-week test with a small list and cadence, then decide by reply and demand signals.' },
    },
    {
      q: { cn: '要先做直銷還是通路？', zh: '要先做直銷還是通路？', en: 'Direct sales or channels first?' },
      a: { cn: '視產品與市場而定。策略會把買家角色與通路路徑拆開，先做最能驗證需求的路徑。', zh: '視產品與市場而定。策略會把買家角色與通路路徑拆開，先做最能驗證需求的路徑。', en: 'Depends on product and market. We separate roles and paths and start with the fastest validation route.' },
    },
  ],
  ctaTitle: { cn: '取得你的市場切入建議', zh: '取得你的市場切入建議', en: 'Get Your Market Entry Plan' },
  ctaDesc: { cn: '提交產品與目標市場，我們回覆分層、通路角色與可行的切入策略。', zh: '提交產品與目標市場，我們回覆分層、通路角色與可行的切入策略。', en: 'Submit your product and markets. We’ll reply with tiers, roles, and a feasible entry plan.' },
  relatedLinks: [
    ...
    { label: { cn: '經銷商開發（核心服務）', zh: '經銷商開發（核心服務）', en: 'Distributor Development (Core)' }, href: '/services/distributor-development' },
