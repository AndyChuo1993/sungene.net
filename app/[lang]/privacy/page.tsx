...
const CONTENT: Record<Lang, { sections: { h: string; p: string }[] }> = {
  en: {
    sections: [
      { h: 'Who we are', p: 'SunGene Co., LTD. is a Taiwan-registered trading company with offices in Taichung, Taiwan and Xiamen, Mainland China. We operate sungene.net to provide direct-buy sourcing services for packaging, home, garden, and beauty product categories.' },
  ...
  zh: {
    sections: [
      { h: '關於我們', p: 'SunGene Co., LTD.(上瑾錸有限公司)是註冊於台灣的貿易公司,在台灣台中與中國大陸廈門設有辦公室。我們經營 sungene.net 提供包裝、家居、園藝、美容品類的直接採購服務。' },
  ...
  cn: {
    sections: [
      { h: '关于我们', p: 'SunGene Co., LTD.(上瑾錸有限公司)是注册于台湾的贸易公司,在台湾台中与中国大陆厦门设有办公室。我们经营 sungene.net 提供包装、家居、园艺、美容品类的直接采购服务。' },
  ...
  fr: {
    sections: [
      { h: 'Qui nous sommes', p: 'SunGene Co., LTD. est une société de négoce enregistrée à Taïwan, avec des bureaux à Taichung (Taïwan) et Xiamen (Chine continentale). Nous exploitons sungene.net pour fournir des services de sourcing direct en emballage, maison, jardin et beauté.' },
  ...
  es: {
    sections: [
      { h: 'Quiénes somos', p: 'SunGene Co., LTD. es una empresa comercial registrada en Taiwán, con oficinas en Taichung (Taiwán) y Xiamen (China continental). Operamos sungene.net para ofrecer servicios de sourcing directo en empaque, hogar, jardín y belleza.' },
