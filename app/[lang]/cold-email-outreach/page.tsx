...
const service: ServiceSeo = {
  ...
  caseStudy: {
    title: { zh: '日本市場：45% 開信率、8% 回覆率（在地化 + 跟進）', en: 'Japan: 45% open rate, 8% reply rate (localization + cadence)' },
    desc: { zh: '以在地化寫法與節奏式跟進克服文化壁壘，建立持續對話。', en: 'Localized messaging and follow-ups overcame barriers and sustained dialogues.' },
    link: '/case-studies/packaging',
  },
  faq: [
    {
      q: { zh: '要跟進幾次？', en: 'How many follow-ups?' },
      a: { zh: '建議 4–6 次，間隔 3–7 天，並逐封加入不同證據（案例/規格/應用）。', en: '4–6 follow-ups, 3–7 days apart, adding different proof points each time.' },
    },
    {
