...
export default async function ConveyorSystemPage({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const legacyPhotos = PHOTO.legacy.conveyor
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Conveyor System', item: `https://sungene.net/${lang}/conveyor-system` },
    ],
  }
  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={t.title}
        desc={t.subtitle}
        image={{ src: heroPhoto, alt: 'Conveyor system in operation', priority: true, aspectClassName: 'aspect-[16/10]' }}
      />
