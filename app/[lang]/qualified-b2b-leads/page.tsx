...
const service: ServiceSeo = {
  ...
  h1: { zh: '合格詢價交付', en: 'Qualified B2B Leads for Manufacturers' },
  problem: {
  ...
  caseStudy: {
    title: { zh: '五金工具：3 個月 50–60 個有效詢價', en: 'Hardware: 50–60 qualified inquiries in 3 months' },
    desc: { zh: '以節奏式跟進與回覆分類別把詢價推進到樣品與報價階段。', en: 'Cadence and triage moved inquiries into sampling and quoting.' },
...
export async function generateMetadata({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  return {
    ...
    alternates: { canonical: `/${lang}/qualified-b2b-leads`, languages: { zh: '/zh/qualified-b2b-leads', en: '/en/qualified-b2b-leads', 'x-default': '/en/qualified-b2b-leads' } },
