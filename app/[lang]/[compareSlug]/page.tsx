  ...
  'vs-sourcing-agent': {
    ...
    zh: {
      ...
      whenUs: {
        ...
        bullets: [
          '我們以 FOB 或 EXW 從工廠買貨,SunGene Co., LTD. 作為買方出現在工廠開立的原始發票上,這是法律意義的所有權轉移',
          '我們在給你的報價單上把「工廠價」與「我方利潤」分行列出,而不是一個合併的總價,你看得到加價結構',
          '下單前你可要求看到底下的工廠原始發票作為證據,我們不會說「對方不方便」—— 因為發票是開給我們的,本來就在我們手上',
          '當貨物驗貨失敗,擋下它是我們的財務決定(我們已經是登記買方,擋下就是我們吃損失或要求工廠重做),不是對你的人情',
          '單一窗口:你的爭議對象是一家台灣註冊公司,適用台灣司法 —— 不是某個工廠老闆的微信號或 Alibaba 客服流程',
          '利潤固定的結構讓「越貴賺越多」這個動機消失 —— 工廠價是我們的成本,壓低工廠價對我們是淨利潤,跟你的利益完全對齊',
          '你看到的工廠發票如果跟我們報價單上的「工廠價」一致,你就驗證了我們的margin是揭露的、不是嘴上說說',
        ],
      },
      tableRows: [
    ...
    cn: {
      ...
      whenUs: {
        ...
        bullets: [
          '我们以 FOB 或 EXW 从工厂买货,SunGene Co., LTD. 作为买方出现在工厂开立的原始发票上,这是法律意义的所有权转移',
          '我们在给您的报价单上把「工厂价」与「我方利润」分行列出,而不是一个合并的总价,您看得到加价结构',
          '下单前您可要求看到底下的工厂原始发票作为证据,我们不会说「对方不方便」—— 因为发票是开给我们的,本来就在我们手上',
          '当货物验货失败,挡下它是我们的财务决定(我们已经是登记买方,挡下就是我们吃损失或要求工厂重做),不是对您的人情',
          '单一窗口:您的争议对象是一家台湾注册公司,适用台湾司法 —— 不是某个工厂老板的微信号或 Alibaba 客服流程',
          '利润固定的结构让「越贵赚越多」这个动机消失 —— 工厂价是我们的成本,压低工厂价对我们是净利润,跟您的利益完全对齐',
          '您看到的工厂发票如果跟我们报价单上的「工厂价」一致,您就验证了我们的 margin 是揭露的、不是嘴上说说',
        ],
      },
      tableRows: [
