...
const CONTENT: Record<Lang, { sections: { h: string; p: string }[] }> = {
  en: {
    sections: [
      ...
      { h: 'Nature of service', p: 'SunGene acts as a buy-and-resell trading principal, not as a commission agent. We purchase goods from vetted factories at FOB or EXW terms and resell to you with a disclosed margin. Underlying factory pricing is shared on request before order confirmation.' },
  ...
  zh: {
    sections: [
      ...
      { h: '服務性質', p: 'SunGene 為買斷再轉售的貿易主體,非抽佣代理。我們以 FOB 或 EXW 條件向審核過的工廠採購,加上揭露的利潤後轉售給你。底下的工廠報價在訂單確認前可應要求分享。' },
  ...
  cn: {
    sections: [
      ...
      { h: '服务性质', p: 'SunGene 为买断再转售的贸易主体,非抽佣代理。我们以 FOB 或 EXW 条件向核查过的工厂采购,加上揭露的利润后转售给你。底下的工厂报价在订单确认前可应要求分享。' },
  ...
  fr: {
    sections: [
      ...
      { h: 'Nature du service', p: 'SunGene agit comme négociant achat-revente, et non comme agent à commission. Nous achetons FOB ou EXW à des usines vérifiées et revendons avec une marge déclarée. Le prix usine sous-jacent est partagé sur demande avant confirmation de commande.' },
  ...
  es: {
    sections: [
      ...
      { h: 'Naturaleza del servicio', p: 'SunGene actúa como comerciante de compra-reventa, no como agente a comisión. Compramos FOB o EXW a fábricas verificadas y revendemos con margen declarado. El precio de fábrica subyacente se comparte bajo solicitud antes de la confirmación.' },
