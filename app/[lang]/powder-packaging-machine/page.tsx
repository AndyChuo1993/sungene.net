...
export default async function PowderPackagingMachinePage({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const legacyPhotos = PHOTO.legacy.powderPackaging
  ...
  const jsonLd = {
    ...
    name: t.title,
    description: descriptions[lang] || descriptions.en,
    url: `https://sungene.net/${lang}/powder-packaging-machine`,
  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={t.title}
        desc={t.subtitle}
        image={{ src: heroPhoto, alt: 'Powder packaging machine in operation', priority: true, aspectClassName: 'aspect-[16/10]' }}
      />
