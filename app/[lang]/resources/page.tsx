...
const categories: (lang: string) => Category[] = (lang) => {
  const t = {
    en: {
      ...
      articles: {
        ...
        'spice-powder-packaging': { title: 'Spice Powder Packaging', desc: 'Packaging solutions for spices, herbs, and seasoning powders — filling accuracy, aroma preservation, and format options.' },
        'flour-packaging': { title: 'Flour Packaging', desc: 'From 500 g retail bags to 25 kg bulk sacks — machines and configurations for wheat flour, rice flour, and specialty flours.' },
        'sauce-filling': { title: 'Sauce Filling', desc: 'Filling lines for sauces, dressings, pastes, and condiments — handling viscosity, particulates, and hygienic design.' },
        ...
        'detergent-powder-packaging': { title: 'Detergent Powder Packaging', desc: 'Packaging equipment for detergent and cleaning powder — dustproof design, accurate dosing, and bag format options.' },
        'what-to-include-in-quote-request': { title: 'What to Include in a Quote Request', desc: 'A checklist of the information suppliers need to give you an accurate quote — product specs, output targets, voltage, and more.' },
    ...
    cn: {
      ...
      articles: {
        ...
        'spice-powder-packaging': { title: '香料粉末包装', desc: '香料、草药和调味粉的包装解决方案——灌装精度、香气保存和包装形式选项。' },
        'flour-packaging': { title: '面粉包装', desc: '从500克零售袋到25千克散装袋——小麦面粉、米粉和特种面粉的机器和配置。' },
        'sauce-filling': { title: '酱料灌装', desc: '酱汁、调料、酱体和调味品的灌装线——处理粘度、颗粒物和卫生设计。' },
        'snack-packing': { title: '零食包装', desc: '薯片、膨化食品、坚果和混合零食的高速VFFS包装——称重集成、充氮和薄膜选项。' },
        'detergent-powder-packaging': { title: '洗涤剂粉末包装', desc: '洗涤剂和清洁粉的包装设备——防尘设计、精确计量和袋型选项。' },
        'what-to-include-in-quote-request': { title: '报价请求中应包含什么', desc: '供应商提供准确报价所需信息的清单——产品规格、产量目标、电压等。' },
    ...
    zh: {
      ...
      articles: {
        ...
        'spice-powder-packaging': { title: '香料粉末包裝', desc: '香料、草藥和調味粉的包裝解決方案——灌裝精度、香氣保存和包裝形式選項。' },
        'flour-packaging': { title: '麵粉包裝', desc: '從500克零售袋到25公斤散裝袋——小麥麵粉、米粉和特種麵粉的機器和配置。' },
        'sauce-filling': { title: '醬料灌裝', desc: '醬汁、調料、醬體和調味品的灌裝線——處理黏度、顆粒物和衛生設計。' },
        'snack-packing': { title: '零食包裝', desc: '薯片、膨化食品、堅果和混合零食的高速VFFS包裝——稱重整合、充氮和薄膜選項。' },
        'detergent-powder-packaging': { title: '洗滌劑粉末包裝', desc: '洗滌劑和清潔粉的包裝設備——防塵設計、精確計量和袋型選項。' },
        'what-to-include-in-quote-request': { title: '報價請求中應包含什麼', desc: '供應商提供準確報價所需信息的清單——產品規格、產量目標、電壓等。' },
  ...
  return [
    ...
    },
    {
      ...
      label: d.application,
      articles: [
        { slug: 'spice-powder-packaging', ...d.articles['spice-powder-packaging'] },
        { slug: 'flour-packaging', ...d.articles['flour-packaging'] },
        { slug: 'sauce-filling', ...d.articles['sauce-filling'] },
        { slug: 'snack-packing', ...d.articles['snack-packing'] },
        { slug: 'detergent-powder-packaging', ...d.articles['detergent-powder-packaging'] },
      ],
    },
    {
      id: 'buying',
      label: d.buying,
      articles: [
        { slug: 'what-to-include-in-quote-request', ...d.articles['what-to-include-in-quote-request'] },
