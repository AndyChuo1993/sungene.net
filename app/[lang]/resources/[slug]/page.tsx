                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <div className="text-xs font-bold uppercase tracking-wider text-accent-700">
                      {({ en: 'LOOKING FOR PRODUCTS?', zh: '想找產品?', cn: '想找产品?', fr: 'À LA RECHERCHE DE PRODUITS ?', es: '¿BUSCA PRODUCTOS?' } as Record<string, string>)[l] || 'LOOKING FOR PRODUCTS?'}
                    </div>
                    <h3 className="mt-1 text-lg font-bold text-brand-950">
                      {({ en: 'SunGene supplies custom packaging, home & living, and outdoor products.', zh: 'SunGene 供應客製紙盒包裝、居家生活、戶外產品。', cn: 'SunGene 供应定制纸盒包装、居家生活、户外产品。', fr: 'SunGene fournit emballages personnalisés, maison & art de vivre et plein air.', es: 'SunGene suministra embalajes personalizados, hogar y vida y exterior.' } as Record<string, string>)[l] || 'SunGene supplies custom packaging, home & living, and outdoor products.'}
                    </h3>
                    <p className="mt-1.5 text-sm text-gray-700">
                      {({ en: 'Custom Packaging · Home & Living · Outdoor — MOQ from USD 1,000. Coordinated supply from Taiwan + China.', zh: '客製包裝 · 居家生活 · 戶外 — MOQ USD 1,000 起。台灣與中國協作供應。', cn: '定制包装 · 居家生活 · 户外 — MOQ USD 1,000 起。台湾与中国协作供应。', fr: 'Emballage personnalisé · Maison & art de vivre · Plein air — MOQ 1 000 USD. Approvisionnement coordonné Taïwan + Chine.', es: 'Embalaje personalizado · Hogar y vida · Exterior — MOQ USD 1 000. Suministro coordinado Taiwán + China.' } as Record<string, string>)[l] || 'Custom Packaging · Home & Living · Outdoor — MOQ from USD 1,000. Coordinated supply from Taiwan + China.'}
                    </p>
                  </div>
