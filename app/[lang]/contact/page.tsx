  ...
  const content: Record<string, any> = {
    en: {
      ...
      contacts: [
        ...
        { label: 'Phone', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: 'Taiwan', value: '台中市中區光復路201號' },
        { label: 'Xiamen', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: 'Submit Inquiry',
    ...
    cn: {
      ...
      contacts: [
        ...
        { label: '电话', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: '台湾地址', value: '台中市中區光復路201號' },
        { label: '厦门地址', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: '提交询价',
    ...
    zh: {
      ...
      contacts: [
        ...
        { label: '電話', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: '台灣地址', value: '台中市中區光復路201號' },
        { label: '廈門地址', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: '提交詢價',
    ...
    fr: {
      ...
      contacts: [{ label: 'Email', value: 'contact@sungene.net' }, { label: 'Tél.', value: '+886 4-3703-2705' }, { label: 'WhatsApp', value: '+86 18144132078' }, { label: 'LINE', value: '@sungene' }, { label: 'Taïwan', value: '台中市中區光復路201號' }, { label: 'Xiamen', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' }],
    ...
    es: {
      ...
      contacts: [{ label: 'Email', value: 'contact@sungene.net' }, { label: 'Teléfono', value: '+886 4-3703-2705' }, { label: 'WhatsApp', value: '+86 18144132078' }, { label: 'LINE', value: '@sungene' }, { label: 'Taiwán', value: '台中市中區光復路201號' }, { label: 'Xiamen', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' }],
      btn: 'Enviar consulta',
    ...
    pt: {
      ...
      contacts: [
        ...
        { label: 'Telefone', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: 'Taiwan', value: '台中市中區光復路201號' },
        { label: 'Xiamen', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
    ...
    ko: {
      ...
      contacts: [
        ...
        { label: '전화', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: '대만', value: '台中市中區光復路201號' },
        { label: '샤먼', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: '문의 제출',
    ...
    ja: {
      ...
      contacts: [
        ...
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: '台湾', value: '台中市中區光復路201號' },
        { label: '厦門', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: 'お問い合わせ送信',
    ...
    ar: {
      ...
      contacts: [
        ...
        { label: 'الهاتف', value: '+886 4-3703-2705' },
        { label: 'واتساب', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: 'تايوان', value: '台中市中區光復路201號' },
        { label: 'شيامن', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: 'إرسال الاستفسار',
    ...
    th: {
      ...
      contacts: [
        ...
        { label: 'โทรศัพท์', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: 'ไต้หวัน', value: '台中市中區光復路201號' },
        { label: 'เซียเหมิน', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: 'ส่งคำถาม',
    ...
    vi: {
      ...
      contacts: [
        { label: 'Email', value: 'contact@sungene.net' },
        { label: 'Điện thoại', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: 'Đài Loan', value: '台中市中區光復路201號' },
        { label: 'Hạ Môn', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
      ],
      btn: 'Gửi yêu cầu',
    ...
    de: {
      ...
      contacts: [
        { label: 'E-Mail', value: 'contact@sungene.net' },
        { label: 'Telefon', value: '+886 4-3703-2705' },
        { label: 'WhatsApp', value: '+86 18144132078' },
        { label: 'LINE', value: '@sungene' },
        { label: 'Taiwan', value: '台中市中區光復路201號' },
        { label: 'Xiamen', value: '厦门市同安区滨海西大道6788-1号银城智谷A1栋1001单元之二' },
