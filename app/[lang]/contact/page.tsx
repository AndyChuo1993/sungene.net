              ...
              <Card className="p-8 shadow-elev-2">
                <InquiryForm
                  ...
                  fields={[
                    ...
                    { name: 'phone', label: ({ en: 'Phone Number', cn: '手机号码', zh: '手機號碼', fr: 'Numéro de téléphone', es: 'Número de teléfono', pt: 'Número de telefone', ko: '전화번호', ja: '電話番号', ar: 'رقم الهاتف', th: 'หมายเลขโทรศัพท์', vi: 'Số điện thoại', de: 'Telefonnummer' } as Record<string,string>)[lang] || 'Phone Number', type: 'phone-intl' },
                    ...
                    { name: 'product', label: ({ en: 'Product / Category', cn: '产品 / 品类', zh: '產品 / 品類', fr: 'Produit / Catégorie', es: 'Producto / Categoría', pt: 'Produto / Categoria', ko: '제품 / 카테고리', ja: '製品 / カテゴリ', ar: 'المنتج / الفئة', th: 'สินค้า / หมวดหมู่', vi: 'Sản phẩm / Danh mục', de: 'Produkt / Kategorie' } as Record<string,string>)[lang] || 'Product / Category', type: 'text', required: true, placeholder: ({ en: 'e.g., stand-up pouches, glass jars, garden tools, airless pumps...', cn: '例如：立袋、玻璃罐、园艺工具、真空泵...', zh: '例如：立袋、玻璃罐、園藝工具、真空泵...', fr: 'ex. pochettes stand-up, bocaux verre, outils jardin, pompes airless...', es: 'ej. bolsas stand-up, frascos de vidrio, herramientas de jardín, bombas airless...', pt: 'ex: bolsas stand-up, frascos de vidro, ferramentas de jardim, bombas airless...', ko: '예: 스탠드업 파우치, 유리병, 정원 도구, 에어리스 펌프...', ja: '例：スタンドアップパウチ、ガラス瓶、ガーデンツール、エアレスポンプ…', ar: 'مثال: أكياس قائمة، برطمانات زجاجية، أدوات حديقة، مضخات بدون هواء...', th: 'เช่น ถุงตั้ง ขวดแก้ว เครื่องมือสวน ปั๊มแอร์เลส...', vi: 'VD: túi đứng, lọ thủy tinh, dụng cụ làm vườn, bơm airless...', de: 'z.B. Standbeutel, Glasgefäße, Gartenwerkzeug, Airless-Pumpen...' } as Record<string,string>)[lang] || '' },
                    { name: 'country', label: ({ en: 'Destination Country', cn: '目标国家', zh: '目標國家', fr: 'Pays de destination', es: 'País de destino', pt: 'País de destino', ko: '도착 국가', ja: '配送先国', ar: 'بلد الوجهة', th: 'ประเทศปลายทาง', vi: 'Quốc gia đích', de: 'Zielland' } as Record<string,string>)[lang] || 'Destination Country', type: 'text' },
