...
export default async function Page({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: lang === 'zh' ? '執行多波段的 Email 與 LinkedIn 開發，透過專業文案主動觸達並篩選意向客戶。' : 'Executing multi-touch Email and LinkedIn campaigns to proactively reach and qualify potential clients with professional copy.',
      icon: (
