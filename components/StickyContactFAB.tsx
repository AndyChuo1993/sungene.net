...
> = {
  en: {
    ...
    contactUs: 'Contact',
    whatsappMsg: "Hi SunGene — I'd like a quotation. I'm currently looking at: ",
  },
  zh: {
    ...
    phone: '台灣辦公室',
    contactUs: '聯絡我們',
    whatsappMsg: '您好 SunGene,我想索取報價,目前在看:',
  },
  cn: {
    ...
    phone: '台湾办公室',
    contactUs: '联系我们',
    whatsappMsg: '您好 SunGene,我想索取报价,目前在看:',
  },
  fr: {
    ...
    phone: 'Bureau Taïwan',
    contactUs: 'Contact',
    whatsappMsg: "Bonjour SunGene — je souhaite un devis. Je consulte actuellement : ",
  },
  es: {
    ...
    contactUs: 'Contacto',
    whatsappMsg: 'Hola SunGene — me gustaría una cotización. Estoy viendo: ',
  },
  pt: {
    ...
    contactUs: 'Contato',
    whatsappMsg: 'Olá SunGene, gostaria de uma cotação. Estou vendo: ',
  },
  ko: {
    ...
    phone: '대만 사무소',
    contactUs: '문의하기',
    whatsappMsg: '안녕하세요 SunGene, 견적을 요청드립니다. 현재 보는 페이지: ',
  },
  ja: {
    ...
    phone: '台湾オフィス',
    contactUs: 'お問い合わせ',
    whatsappMsg: 'SunGene 様、お見積もりをお願いします。閲覧中のページ：',
  },
  ar: {
    ...
    whatsappMsg: 'مرحبًا SunGene، أود طلب عرض سعر. الصفحة التي أتصفحها: ',
  },
  th: {
    ...
    contactUs: 'ติดต่อเรา',
    whatsappMsg: 'สวัสดี SunGene ขอใบเสนอราคา กำลังดูหน้า: ',
  },
  vi: {
    ...
    contactUs: 'Liên hệ',
    whatsappMsg: 'Xin chào SunGene, tôi muốn xin báo giá. Đang xem trang: ',
  },
  de: {
    ...
    phone: 'Büro Taiwan',
    contactUs: 'Kontakt',
    whatsappMsg: 'Hallo SunGene, ich möchte ein Angebot. Aktuelle Seite: ',
  },
}
