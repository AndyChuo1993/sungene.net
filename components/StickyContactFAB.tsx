...
> = {
  en: {
    ...
    contactUs: 'Contact',
    whatsappMsg: "Hi SunGene — I'd like a sourcing quote. I'm currently looking at: ",
  },
  zh: {
    ...
    phone: '台灣辦公室',
    contactUs: '聯絡我們',
    whatsappMsg: '您好 SunGene,我想索取採購報價,目前在看:',
  },
  cn: {
    ...
    phone: '台湾办公室',
    contactUs: '联系我们',
    whatsappMsg: '您好 SunGene,我想索取采购报价,目前在看:',
  },
  fr: {
    ...
    phone: 'Bureau Taïwan',
    contactUs: 'Contact',
    whatsappMsg: "Bonjour SunGene — je souhaite un devis de sourcing. Je consulte actuellement : ",
  },
  es: {
    ...
    contactUs: 'Contacto',
    whatsappMsg: 'Hola SunGene — me gustaría una cotización de sourcing. Estoy viendo: ',
  },
  pt: {
