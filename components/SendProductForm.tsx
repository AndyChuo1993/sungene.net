...
const labels: Record<string, Record<string, string>> = {
  en: {
    sectionTitle: 'Send Your Product — Get a Quotation',
    sectionDesc: 'Fill in your product details and we\'ll reply with the right product recommendation, configuration, and next steps within 24 hours.',
    name: 'Your Name',
    email: 'Email Address',
    ...
    successDesc: 'We\'ve received your product details. Our team will reply with a quotation within 24 hours.',
  ...
  cn: {
    sectionTitle: '发送您的产品 — 索取报价',
    sectionDesc: '填写您的产品信息，我们将在24小时内回复合适的产品推荐、配置与下一步建议。',
    name: '您的姓名',
    email: '电子邮箱',
    productType: '您的产品',
    ...
    submitting: '发送中...',
    successTitle: '感谢您！',
    successDesc: '我们已收到您的产品信息！我们的团队将在24小时内回复报价。',
    submitAnother: '再次提交',
    errorTitle: '提交失败',
  ...
  zh: {
    sectionTitle: '傳送您的產品 — 索取報價',
    sectionDesc: '填寫您的產品資訊，我們將在24小時內回覆合適的產品推薦、配置與下一步建議。',
    name: '您的姓名',
    email: '電子郵件',
    productType: '您的產品',
    ...
    submitting: '傳送中...',
    successTitle: '感謝您！',
    successDesc: '我們已收到您的產品資訊！團隊將在24小時內回覆報價。',
    submitAnother: '再次提交',
    errorTitle: '提交失敗',
