  ...
  const content: Record<string, any> = {
    ...
    pt: {
      ...
      items: [
        ...
        { q: 'Vocês podem personalizar produtos sourced conforme nossas especificações?', a: 'Sim. Nossa equipe de engenharia pode personalizar dimensões, materiais , capacidade, embalagem e nível de automação para atender às condições do seu site.' },
    ...
    ko: {
      ...
      items: [
        ...
        { q: '사양에 맞게 제품을 맞춤 설정할 수 있나요?', a: '네. 치수, 재질, 용량, 포장 사양 및 자동화 수준을 현장 조건에 맞춰 구성할 수 있습니다.' },
    ...
    ja: {
      ...
      items: [
        ...
        { q: '仕様に合わせて製品をカスタマイズできますか？', a: 'はい。当社のエンジニアリングチームは、寸法、材質、生産能力、包装仕様、自動化レベルをお客様の生産環境に合わせてカスタマイズできます。' },
    ...
    ar: {
      ...
      items: [
        ...
        { q: 'هل يمكنكم تخصيص المنتجات وفقاً لمواصفاتنا؟', a: 'نعم. يمكن لفريقنا الهندسي تخصيص الأبعاد والمواد  والطاقة الإنتاجية ومواصفات التغليف ومستوى الأتمتة لتتناسب مع بيئة الإنتاج الخاصة بكم.' },
    ...
    th: {
      ...
      items: [
        ...
        { q: 'สามารถปรับแต่งผลิตภัณฑ์ตามสเปคของเราได้หรือไม่?', a: 'ได้ ทีมวิศวกรรมของเราสามารถปรับแต่งขนาด วัสดุ  กำลังการผลิต ข้อกำหนดบรรจุภัณฑ์ และระดับอัตโนมัติให้เหมาะกับสภาพแวดล้อมการผลิตของคุณ' },
    ...
    vi: {
      ...
      items: [
        ...
        { q: 'Các bạn có thể tùy chỉnh sản phẩm theo thông số của chúng tôi không?', a: 'Có. Đội ngũ kỹ thuật có thể tùy chỉnh kích thước, vật liệu , công suất, thông số bao bì và mức độ tự động hóa phù hợp với môi trường sản xuất của bạn.' },
    ...
    de: {
      ...
      items: [
        ...
        { q: 'Können Sie Produkte nach unseren Spezifikationen anpassen?', a: 'Ja. Unser Ingenieurteam kann Abmessungen, Materialien , Produktionskapazität, Verpackungsspezifikation und Automatisierungsgrad an Ihre Produktionsumgebung anpassen.' },
