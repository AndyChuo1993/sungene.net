...
export default function HeroSection({ lang }: { lang: Lang }) {
  const content: Record<string, any> = {
    en: {
      ...
      sub: 'A Taiwan–China dual-entity trading company. We buy from vetted factories and resell to you direct — on-site QC by our own team, no factory kickbacks, transparent quotes.',
      subSecondary: 'Verified Alibaba.com supplier. Direct factory pricing, end-to-end export logistics, same-day quotes. Orders from USD 1,000.',
    ...
    zh: {
      ...
      sub: '台灣＋中國雙主體的貿易公司。我們直接向審查過的工廠採購、轉手出貨給你——驗貨由團隊親自到場、不收工廠紅包、報價透明。',
      subSecondary: 'Alibaba.com 認證供應商。直接工廠價、端到端出口物流、當日報價。訂單從 USD 1,000 起接。',
      btnQuote: '索取報價',
      btnCatalog: '我們怎麼合作',
      stats: [
    ...
    cn: {
      ...
      sub: '台湾＋中国双主体的贸易公司。我们直接向核查过的工厂采购、转手出货给您——验货由团队亲自到场、不收工厂红包、报价透明。',
      subSecondary: 'Alibaba.com 认证供应商。直接工厂价、端到端出口物流、当日报价。订单从 USD 1,000 起接。',
      btnQuote: '索取报价',
      btnCatalog: '我们怎么合作',
      stats: [
    ...
    fr: {
      ...
      sub: "Société de négoce à double entité Taïwan-Chine. Nous achetons auprès d'usines vérifiées puis vous revendons en direct — contrôle qualité sur place par notre équipe, aucune commission occulte, devis transparents.",
    ...
    es: {
      ...
      sub: 'Empresa comercial con doble entidad Taiwán-China. Compramos a fábricas verificadas y le revendemos directamente — control de calidad en sitio realizado por nuestro equipo, sin comisiones encubiertas, presupuestos transparentes.',
