...
const dict: Record<string, Record<string, string>> = {
  ...
  'pt': {
    ...
    nav_sol_custom: 'Máquina sob medida', nav_sol_export: 'Serviço de exportação',
    meta_home_title: 'SunGene | Máquinas de Embalagem, Processamento de Alimentos e Automação Industrial | Fabricante taiwanês',
    meta_home_desc: 'SunGene fabrica e exporta máquinas de embalagem, equipamentos de processamento de alimentos, sistemas de envase e selagem e linhas de produção automatizadas. Certificação CE, preço de fábrica, exportação para mais de 50 países.',
  ...
  'ko': {
    ...
    nav_sol_custom: '맞춤형 기계', nav_sol_export: '수출 서비스',
    meta_home_title: 'SunGene | 포장기계, 식품가공장비 및 산업자동화 | 대만 제조업체',
    meta_home_desc: 'SunGene은 포장기계, 식품가공장비, 충전 및 밀봉 시스템, 자동화 생산라인을 제조 및 수출합니다. CE 인증, 공장 직판가, 50개국 이상 수출.',
  ...
  'ja': {
    ...
    nav_sol_custom: 'カスタム機械', nav_sol_export: '輸出サービス',
    meta_home_title: 'SunGene | 包装機械・食品加工機器・産業自動化 | 台湾メーカー',
    meta_home_desc: 'SunGeneは包装機械、食品加工機器、充填・シールシステム、自動化生産ラインを製造・輸出しています。CE認証、工場直販価格、50カ国以上へ輸出。',
  ...
  'ar': {
    ...
    nav_sol_custom: 'آلات مخصصة', nav_sol_export: 'خدمة التصدير',
    meta_home_title: 'SunGene | آلات التعبئة والتغليف ومعدات تصنيع الأغذية والأتمتة الصناعية | شركة تصنيع تايوانية',
    meta_home_desc: 'SunGene تصنع وتصدر آلات التعبئة والتغليف ومعدات تصنيع الأغذية وأنظمة التعبئة والإغلاق وخطوط الإنتاج الآلية. شهادة CE، أسعار المصنع مباشرة، تصدير إلى أكثر من 50 دولة.',
  ...
  'th': {
    ...
    nav_sol_custom: 'เครื่องจักรสั่งทำ', nav_sol_export: 'บริการส่งออก',
    meta_home_title: 'SunGene | เครื่องบรรจุภัณฑ์ อุปกรณ์แปรรูปอาหาร และระบบอัตโนมัติ | ผู้ผลิตไต้หวัน',
    meta_home_desc: 'SunGene ผลิตและส่งออกเครื่องบรรจุภัณฑ์ อุปกรณ์แปรรูปอาหาร ระบบบรรจุและซีล และสายการผลิตอัตโนมัติ ใบรับรอง CE ราคาโรงงาน ส่งออกกว่า 50 ประเทศ',
  ...
  'vi': {
    ...
    nav_sol_custom: 'Máy tùy chỉnh', nav_sol_export: 'Dịch vụ xuất khẩu',
    meta_home_title: 'SunGene | Máy đóng gói, Thiết bị chế biến thực phẩm & Tự động hóa công nghiệp | Nhà sản xuất Đài Loan',
    meta_home_desc: 'SunGene sản xuất và xuất khẩu máy đóng gói, thiết bị chế biến thực phẩm, hệ thống chiết rót và hàn kín, dây chuyền sản xuất tự động. Chứng nhận CE, giá nhà máy, xuất khẩu hơn 50 quốc gia.',
  ...
  'de': {
    ...
    nav_sol_custom: 'Sondermaschinen', nav_sol_export: 'Export-Service',
    ...
    meta_home_desc: 'SunGene produziert und exportiert Verpackungsmaschinen, Lebensmittelverarbeitungsanlagen, Abfüll- und Verschließsysteme sowie automatisierte Produktionslinien. CE-zertifiziert, ab Werk, Export in über 50 Länder.',
