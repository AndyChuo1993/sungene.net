...
const dict: Record<string, Record<string, string>> = {
  ...
  'fr': {
    ...
    meta_home_desc: 'Partenaire de sourcing avec équipes à Taichung et Xiamen. Usines Taïwan + Chine pour emballage, maison, jardin, beauté. CQ sur place, Alibaba 5-star. MOQ 1 000 USD.',
  ...
  'es': {
    ...
    meta_home_desc: 'Socio de sourcing con equipos en Taichung y Xiamen. Compramos a fábricas verificadas Taiwán + China para empaque, hogar, jardín y belleza. QC en sitio, Alibaba 5-star verificado, MOQ USD 1 000.',
