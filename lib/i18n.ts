...
const dict: Record<string, Record<string, string>> = {
  'cn': {
    ...
    nav_sol_custom: '定制机械',
    meta_home_title: 'SunGene｜台湾＋中国 采购伙伴｜包装・家居・园艺',
    meta_home_desc: '台湾与中国双公司架构的小型贸易商。直接向核查过的工厂下单、转手出货给您——亲自验货、不收工厂红包、报价透明。Alibaba.com 经营三年，最低订单 USD 1,000。',
    meta_keywords: '台湾采购伙伴, 中国采购代理, 包装产品采购, 家居用品采购, 园艺产品采购, Alibaba 验厂, 台湾贸易商, 验货服务, 不收红包',
  ...
  'zh': {
    ...
    nav_sol_custom: '客製機械',
    meta_home_title: 'SunGene｜台灣＋中國 採購夥伴｜包裝・家居・園藝',
    meta_home_desc: '台灣與中國雙公司架構的小型貿易商。直接向審查過的工廠下單、轉手出貨給你——親自驗貨、不收工廠紅包、報價透明。Alibaba.com 經營三年，最低訂單 USD 1,000。',
    meta_keywords: '台灣採購夥伴, 中國採購代理, 包裝產品採購, 家居用品採購, 園藝產品採購, Alibaba 驗廠, 台灣貿易商, 驗貨服務, 不收紅包',
    form_submitting: '提交中...', form_success_title: '提交成功',
  ...
  'en': {
    ...
    meta_home_title: 'SunGene | Taiwan + China sourcing partner for packaging, home & garden brands',
    meta_home_desc: 'Taiwan–China dual-office trading company. We buy from vetted factories and resell to you direct — on-site QC by our own team, no factory kickbacks, transparent quotes. Three years on Alibaba.com. MOQ USD 1,000.',
    meta_keywords: 'Taiwan sourcing partner, China sourcing agent, packaging sourcing, home goods sourcing, garden products sourcing, Alibaba supplier, Taiwan trading company, factory inspection, no kickbacks',
  ...
  'fr': {
    ...
    meta_home_title: "SunGene | Sourcing Taïwan + Chine pour marques d'emballage, maison & jardin",
  ...
  'es': {
    ...
    meta_home_title: 'SunGene | Sourcing Taiwán + China para marcas de empaque, hogar y jardín',
    meta_home_desc: 'Empresa comercial con oficinas en Taiwán y China. Compramos a fábricas verificadas y revendemos directamente — control de calidad en sitio, sin comisiones encubiertas, presupuestos transparentes. Tres años en Alibaba.com. Pedido mín. USD 1 000.',
