...
const dict: Record<string, Record<string, string>> = {
  'cn': {
    ...
    meta_home_desc: '台中与厦门两地有采购团队,向两岸审查过的工厂直接下单采购并转售。包装、家居、园艺、美容品类,整合货柜出口,出货前由 SunGene 员工验货。工厂价与我方利润分行揭露。Alibaba 5 星认证,MOQ USD 1,000。',
  ...
  'zh': {
    ...
    meta_home_desc: '台中與廈門兩地有採購團隊,向兩岸審查過的工廠直接下單採購並轉售。包裝、家居、園藝、美容品類,整合貨櫃出口,出貨前由 SunGene 員工驗貨。工廠價與我方利潤分行揭露。Alibaba 5 星認證,MOQ USD 1,000。',
  ...
  'fr': {
    ...
    meta_home_desc: 'Partenaire de sourcing Taïwan + Chine: usines vérifiées pour emballage, maison, jardin, beauté. CQ sur place, Alibaba 5-star. MOQ 1 000 USD.',
  ...
  'es': {
    ...
    meta_home_desc: 'Sourcing Taiwán + China: compra directa a fábricas verificadas para empaque, hogar, jardín y belleza. QC en sitio, Alibaba 5-star. MOQ USD 1 000.',
