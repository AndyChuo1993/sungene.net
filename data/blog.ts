...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: { zh: '外銷最常見失敗原因是什麼？', en: 'What is the most common reason exporters fail?' }, a: { zh: '沒有把流程做成系統：只做一次名單或只寄一次信，沒有跟進節奏與回覆分類，導致大量商機流失。', en: 'Lack of a system—one-off lists and one-and-done outreach without cadence and triage causes massive lead leakage.' } },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: { zh: '如何快速判斷經銷商品質？', en: 'How to quickly vet distributor quality?' }, a: { zh: '看產品線互補、客群匹配、售後能力、在地倉儲，以及是否能清楚說出他們的銷售渠道與年度目標。', en: 'Check product fit, customer base, service capacity, local warehousing, and whether they can articulate channels and annual targets.' } },
    ],
    internalLinks: { servicePath: '/services/distributor-development', caseStudyPath: '/case-studies', leadMagnetPath: '/distributor-list' },
  },
  {
  ...
  },
  {
    ...
    faq: [
      { q: { zh: '德國市場回覆率偏低怎麼辦？', en: 'What if reply rates are low in Germany?' }, a: { zh: '優先優化名單角色與證據點：把職位鎖定在技術/採購/通路決策者，並在跟進信中逐步加入規格、認證與案例。', en: 'Optimize role targeting and proof: focus on technical/procurement/channel decision-makers and add specs, certifications, and cases across follow-ups.' } },
    ],
    internalLinks: { servicePath: '/services/distributor-development', caseStudyPath: '/case-studies', leadMagnetPath: '/distributor-list' },
  },
  {
  ...
  },
  {
    ...
    date: '2026-03-13',
    heroImage: '/articles/cold-email-mistakes.svg',
    title: { zh: '展會名單如何跟進：展前邀約、展後節奏與詢盤分類', en: 'Trade Show Follow-up: Pre-show Invites, Post-show Cadence, and Lead Triage' },
    description: { zh: '把展會名單變成可成交詢盤：邀約模板、跟進節奏、回覆分類與下一步。', en: 'Turn trade show lists into real pipeline: templates, cadence, triage, and next steps.' },
    sections: [
      ...
      { id: 'triage', heading: { zh: '回覆分類', en: 'Reply triage' }, content: { zh: ['合格/培育/不匹配，並為每一類設定下一步模板。'], en: ['Qualified/nurture/no-fit and define next-step templates for each category.'] } },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      { id: 'tiers', heading: { zh: '市場分層（Market tiers）', en: 'Market tiers' }, content: { zh: ['東南亞不是單一市場。建議先用「需求強度、競品密度、認證門檻、物流可行性」分層，再選 1–2 個優先市場。'], en: ['Southeast Asia is not one market. Tier by demand, competitive density, compliance, and logistics, then pick 1–2 priority markets.'] } },
      ...
      { id: 'checklist', heading: { zh: '清單（Checklist）', en: 'Checklist' }, content: { zh: ['產品摘要（英語）', '可接受條件（MOQ/交期/付款）', '100 家驗證名單', '4–6 次節奏跟進', '回覆分類與交付格式'], en: ['English brief', 'Acceptable terms (MOQ/lead time/payment)', '100 verified prospects', '4–6 touch cadence', 'Reply triage + delivery format'] } },
    ],
    faq: [
  ...
  },
  {
    ...
    faq: [
      { q: { zh: '要先找代理還是找專案承包商？', en: 'Agent first or contractors first?' }, a: { zh: '看產品與成交方式：標準品通常走通路；解決方案/系統型產品可同時觸達承包商與整合商。', en: 'Depends on product and selling motion: standardized products often go through channels; solution/system products should target contractors and integrators in parallel.' } },
    ],
    internalLinks: { servicePath: '/services/distributor-development', caseStudyPath: '/case-studies', leadMagnetPath: '/export-market-analysis' },
  },
  {
  ...
  },
  {
    ...
    sections: [
      { id: 'sources', heading: { zh: '常見來源（Sources）', en: 'Sources' }, content: { zh: ['常見包含：產業協會名錄、展會參展名單、B2B 平台分類頁、以及特定產業 directory。'], en: ['Common sources: association directories, trade show exhibitor lists, B2B platform category pages, and niche industry directories.'] } },
      { id: 'validation', heading: { zh: '驗證（Validation）', en: 'Validation' }, content: { zh: ['驗證至少包含：公司網站、產品匹配、地區覆蓋、以及決策鏈角色。把名單變成可追蹤資料庫。'], en: ['Validate via website, product fit, coverage, and decision-chain roles. Turn raw lists into a trackable database.'] } },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'cadence', heading: { zh: '推進節奏', en: 'Cadence' }, content: { zh: ['第一封先建立可信度（規格/認證/案例），第二封補合作條款，第三封邀約會議。'], en: ['Email 1 builds credibility (specs/certs/cases), email 2 adds terms, email 3 invites a meeting.'] } },
    ],
    faq: [
  ...
  },
  {
    ...
    date: '2026-03-13',
    heroImage: '/articles/lead-gen-guide.svg',
    title: { zh: '7 種常見 B2B 資料庫：找海外買家、匯出名單與驗證方法', en: '7 Common B2B Databases: Find Overseas Buyers, Export Lists, and Validate' },
    description: { zh: 'B2B 資料庫是名單起點，不是答案。本文用清單整理常見資料庫類型與驗證方法，避免名單稀釋。', en: 'B2B databases are list seeds, not the answer. A practical list of database types and validation tips.' },
    sections: [
      { id: 'list', heading: { zh: '資料庫類型（7 Types）', en: 'Database types (7)' }, content: { zh: ['類型包含：公司資料庫、海關/進出口資料、展會名單、產業目錄、協會名錄、招標/專案資料、社群/職涯資料。'], en: ['Types include company databases, import/export data, trade show lists, directories, association lists, tender/project data, and social/career data.'] } },
      ...
      { id: 'checklist', heading: { zh: '清單（Checklist）', en: 'Checklist' }, content: { zh: ['資料來源分群', '角色標籤', '去重與清洗', '驗證欄位一致', '節奏與回覆分類'], en: ['Segment sources', 'Role tags', 'Dedup and clean', 'Consistent fields', 'Cadence and triage'] } },
    ],
    faq: [
      { q: { zh: '買資料庫名單就夠了嗎？', en: 'Is buying a database list enough?' }, a: { zh: '通常不夠。你仍需要驗證與角色標籤，並用節奏式開發把名單轉成可交付詢盤。', en: 'Usually not. You still need validation and role tags, plus cadence-based outreach to convert lists into deliverable inquiries.' } },
    ],
    internalLinks: { servicePath: '/services/export-lead-generation', caseStudyPath: '/case-studies', leadMagnetPath: '/buyers-list' },
  },
  {
    ...
    date: '2026-03-13',
    heroImage: '/articles/lead-gen-guide.svg',
    title: { zh: '製造業買家資料庫建立：欄位設計、驗證流程與交付格式', en: 'Buyer Database Building for Manufacturers: Fields, Validation, and Delivery' },
    description: { zh: '名單不是越多越好，而是越可用越好。本文提供資料庫欄位與驗證流程，讓開發更可追蹤。', en: 'Lists should be usable, not just large. A practical database field set and validation workflow for trackable outreach.' },
    sections: [
    ...
    faq: [
      { q: { zh: '資料庫需要多久更新一次？', en: 'How often should we refresh the database?' }, a: { zh: '建議每月做清洗與補齊，並把「回覆結果」反饋到名單，形成越跑越準的資料資產。', en: 'Monthly cleanup is a good baseline. Feed reply outcomes back into the database to build a compounding asset.' } },
    ],
    internalLinks: { servicePath: '/services/export-lead-generation', caseStudyPath: '/case-studies', leadMagnetPath: '/buyers-list' },
  },
  {
    ...
    sections: [
      { id: 'checklist', heading: { zh: '篩選清單（Checklist）', en: 'Checklist' }, content: { zh: ['產品線互補與價格帶', '客群與產業匹配', '地區覆蓋與銷售渠道', '售後與技術支援能力', '是否能給出年度目標與推廣計畫'], en: ['Product complement and pricing band', 'Customer/industry fit', 'Coverage and channels', 'Service and technical support', 'Clear targets and promotion plan'] } },
      { id: 'questions', heading: { zh: '建議問的 5 個問題', en: '5 questions to ask' }, content: { zh: ['你們的主要客群與前 5 大產品線是什麼？', '你們覆蓋哪些地區與哪些渠道？', '你們的售後與維修如何處理？', '你們希望的毛利與合作條件？', '你們的年度銷售目標與推廣計畫？'], en: ['Who are your main customers and top 5 lines?', 'Which regions and channels do you cover?', 'How do you handle service and warranty?', 'What margins and terms do you expect?', 'What are your annual targets and promotion plan?'] } },
    ],
    faq: [
