...
export const seoIndustries: SeoIndustry[] = [
  ...
  },
  {
    ...
    challenges: { zh: ['規格導向、導入週期長', '需要驗證與可靠性資料', '替代料與價格競爭激烈'], en: ['Spec-driven and long design-in cycles', 'Requires certification and reliability data', 'Heavy competition for alternatives and price'] },
    ...
    ctaTitle: { zh: '想提升電子買家詢價？', en: 'Need more electronics buyer inquiries?' },
  ...
  },
  {
    ...
    strategy: { zh: ['名單以產品應用分類別（套件裝/工業/醫療等），訊息聚焦應用痛點。', '強調品管體系與一致性：材料追溯、檢驗流程、良率。', '提供快速打樣流程與可預期的導入節奏。'], en: ['Segment by application and tailor messaging to pain points.', 'Emphasize QC and consistency: traceability, inspection, yield.', 'Offer fast sampling workflows and predictable onboarding.'] },
  ...
  },
  {
    ...
    faq: [
      { q: { zh: '需要先準備哪些文件？', en: 'What documents should we prepare?' }, a: { zh: '建議準備 MSDS、TDS、COA 範例、套件裝規格與危險品運輸條件說明。', en: 'Prepare MSDS, TDS, sample COA, packaging specs, and hazmat shipping terms.' } },
    ],
  },
  {
    slug: 'medical',
    ...
    strategy: { zh: ['用案例與文件建立信任：驗證、測試、品質流程。', '分層開發：經銷商與品牌採購分開策略。', '以小量試單與合規資料套件推進導入。'], en: ['Build trust with certifications, tests, and QC process.', 'Segment distributors vs brands with different sequences.', 'Use trial orders and compliance packs to move onboarding forward.'] },
  ...
  },
  {
    ...
    opportunities: { zh: ['新能源車帶動零元件替代與新需求', '區域供應鏈重組增加 Second Source', '售後市場與維修通路需求穩定'], en: ['EV growth drives new parts demand', 'Regional reshoring increases second-source needs', 'Aftermarket demand remains stable'] },
  ...
  },
  {
    ...
    strategy: { zh: ['把設備分成可複製的解決方案套件（Use Case）來寫內容與開發。', '在文案中加入導入條件與資料需求，降低來回溝通。', '建立「案例＋規格＋導入流程」三件套，提高信任與回覆率。'], en: ['Package messaging by repeatable use cases.', 'Include integration requirements to reduce back-and-forth.', 'Use a trio: case + specs + onboarding steps to build trust and replies.'] },
    ctaTitle: { zh: '想增加工業設備海外詢價？', en: 'Want more industrial equipment inquiries?' },
    ...
    faq: [
      { q: { zh: '我們產品很客製，適合做 SEO 嗎？', en: 'Our solutions are customized. Is SEO still worth it?' }, a: { zh: '適合。用「應用情境」與「產業問題」做內容結構，比用規格堆砌更能帶來高品質詢價。', en: 'Yes. Organizing content by use cases and industry problems attracts higher-quality leads than spec-heavy pages.' } },
    ],
  },
]
