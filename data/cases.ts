...
const zh: Record<string, CaseContent> = {
  hardware: {
    ...
    sections: [
      ...
      { heading: '我們的策略', paragraphs: ['我們為其量身打造外貿外包方案，從零建立歐洲開發體系：'], items: ['鎖定德國、荷蘭中大型五金進口商與批發商', '建立採購經理的精準名單', '設計強調台灣製造品質與代工彈性的英文開發信'] },
      { heading: '執行方式', items: ['首月：建立 500 家以上目標客戶名單，進行首輪測試', '次月：優化開發信主旨與內容，提升開啟率至 40% 以上', '第三個月：全面自動化跟進，並由團隊協助初步詢問篩選'] },
      { heading: '成果數據', items: ['3個月內累計獲得 50-60 個有效詢問', '多個詢問來自德國知名工具品牌', '超過 10 個潛在客戶進入樣品與報價階段'] },
  ...
  electronics: {
    ...
    sections: [
      ...
      { heading: '成果數據', items: ['成功繞過一般詢價信箱，直接與 20 多位工程主管建立聯繫', '獲得多家大廠的樣品測試機會', '正式進入北美供應鏈審核流程'] },
  ...
  packaging: {
    ...
    sections: [
      ...
      { heading: '成果數據', items: ['開發信開啟率達 45%，高於常見平均水準', '回覆率達到 8%，成功建立多個持續對話', '成功與數家日本化妝品品牌展開代工洽談'] },
  ...
  industrial: {
    ...
    sections: [
      ...
      { heading: '我們的策略', paragraphs: ['採用技術型業務開發方式：'], items: ['鎖定工廠廠長、製程工程師、研發總監等技術職位', '開發信內容強調效能提升與成本優化數據', '提供技術規格書與測試報告作為核心素材'] },
  ...
  machinery: {
    ...
    sections: [
      ...
      { heading: '我們的策略', paragraphs: ['結合名單開發與會議邀約：'], items: ['建立越南與泰國前 50 大包裝機械進口商名單', '透過當地語言（越文與泰文）進行陌生開發電話', '目標是直接安排視訊會議，而非僅止於索取報價'] },
