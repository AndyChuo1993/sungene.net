...
const zh: Record<string, CaseContent> = {
  ...
  electronics: {
    ...
    sections: [
      { heading: '背景', paragraphs: ['客戶為電子零元件廠，目標是切入北美高科技與車用電子供應鏈，但受限於大廠採購流程封閉，難以接觸關鍵決策者。'] },
...
const cn: Record<string, CaseContent> = {
  hardware: {
    ...
    industry: '五金工具',
    market: '欧洲',
    serviceType: '客户开发与邮件开发',
    duration: '3个月',
    cover: baseCovers.hardware,
    proofImages: [proofImages.chart],
    summary: '协助企业建立海外买家名单并进行客户开发，成功建立多个潜在客户联系与合作机会。',
    result: '询盘增长与市场拓展',
    highlights: [
      { num: '50-60', label: '有效询盘' },
      { num: '3个月', label: '建立稳定来源' },
      { num: '10+', label: '进入报价阶段' },
    ],
    ...
    sections: [
      ...
      { heading: '成果数据', items: ['3个月内累计获得 50-60 个有效询盘', '多个询盘来自德国知名工具品牌', '超过 10 个潜在客户进入样品与报价阶段'] },
      { heading: '关键价值', items: ['无需自建团队即可启动海外开发', '快速验证欧洲市场对产品的接受度', '建立可复制的企业客户开发标准作业流程'] },
    ],
  },
  electronics: {
    slug: 'electronics',
    ...
    industry: '电子零部件',
    market: '北美',
    serviceType: '商务社交接触与重点客户开发',
    duration: '2个月',
    cover: baseCovers.electronics,
    proofImages: [proofImages.map],
    summary: '通过海外客户开发流程，协助企业接触采购决策者并建立商务对话。',
    result: '切入供应链并接触关键决策人',
    highlights: [
      { num: '100%', label: '决策人触达' },
      { num: '2周', label: '获得样品单' },
      { num: '北美', label: '成功落地' },
    ],
    before: ['无法接触决策人', '信件石沉大海', '竞争激烈'],
    after: ['精准锁定主管', '多点触达', '进入审核流程'],
    sections: [
      { heading: '背景', paragraphs: ['客户为电子零部件厂，目标是切入北美高科技与车用电子供应链，但受限于大厂采购流程封闭，难以接触关键决策者。'] },
      { heading: '市场困境', items: ['一般 info 信箱回复率极低', '采购决策链长，涉及工程、采购、品管多个部门', '竞争对手众多，难以突显技术优势'] },
      { heading: '我们的策略', paragraphs: ['采用多角色接触策略：'], items: ['同时锁定目标企业的采购经理、研发主管与供应链总监', '通过商务社交与邮件进行多渠道接触', '撰写技术导向的白皮书与案例作为切入素材'] },
      { heading: '执行方式', items: ['建立北美前 50 家目标客户的组织架构图', '针对工程与采购角色分别设计不同的沟通内容', '利用商务社交建立专业形象与信任感'] },
      { heading: '成果数据', items: ['成功绕过一般询盘信箱，直接与 20 多位工程主管建立联系', '获得多家大厂的样品测试机会', '正式进入北美供应链审核流程'] },
      { heading: '关键价值', items: ['成功接触大厂采购与技术决策角色', '缩短新供应商导入周期', '提升品牌在北美市场的专业能见度'] },
    ],
  },
  packaging: {
    slug: 'packaging',
    ...
    industry: '软包装材料',
    market: '日本',
    serviceType: '本地化内容与主动开发',
    duration: '12个月以上',
    cover: baseCovers.packaging,
    proofImages: [proofImages.chart],
    summary: '日本市场开启率 45%、回复率 8%，成功克服语言与文化差异。',
    result: '本地化经营与稳定回复',
    highlights: [
      { num: '45%', label: '开信率' },
      { num: '8%', label: '回复率' },
    ...
    before: ['语言隔阂', '市场封闭', '信任建立难'],
    after: ['日文本地化', '精准名单', '高互动率'],
    sections: [
      { heading: '背景', paragraphs: ['客户为软包装材料供应商，希望拓展日本与东南亚市场。日本市场以封闭与重视信任著称，过去使用英文开发效果不佳。'] },
      { heading: '市场困境', items: ['语言障碍导致沟通不顺', '日本客户对陌生海外供应商信任度低', '缺乏精准的终端品牌客户名单（食品、化妆品厂）'] },
      { heading: '我们的策略', paragraphs: ['实施深度本地化的开发策略：'], items: ['建立日本食品、美妆与日用品工厂的精准名单', '由日文顾问协助润饰开发信，确保商务礼仪与语气自然', '强调质量检验标准与既有日系客户实绩，以建立信任'] },
      { heading: '执行方式', items: ['分行业建立名单，优先锁定中型品牌商', '使用日文进行所有书面沟通', '提供免费样品寄送服务作为破冰诱因'] },
      { heading: '成果数据', items: ['开发信开启率达 45%，高于常见平均水准', '回复率达到 8%，成功建立多个持续对话', '成功与数家日本化妆品品牌展开代工洽谈'] },
      { heading: '关键价值', items: ['克服文化与语言差异', '建立日系客户的信任感', '更有效率地切入重视信任的市场'] },
    ],
  },
  industrial: {
    slug: 'industrial',
    ...
    cover: baseCovers.industrial,
    proofImages: [proofImages.map],
    summary: '触达高层决策者、进入大型客户评估流程，建立技术销售管道。',
    result: '技术销售、大型项目',
    highlights: [
      { num: 'Top 20', label: '目标客户触达' },
      { num: '稳定', label: '询盘节奏' },
      { num: '高层', label: '直接对话' },
    ],
    ...
    sections: [
      ...
      { heading: '成果数据', items: ['短时间内触达多位目标企业的高层决策者', '建立稳定的技术询盘来源', '成功进入两家大型石化集团的供应商评估清单'] },
      { heading: '关键价值', items: ['更精准地对应技术需求', '缩短冗长的技术审核时间', '建立较高门槛的技术竞争优势'] },
    ],
  },
  machinery: {
    slug: 'machinery',
    ...
    cover: baseCovers.machinery,
    proofImages: [proofImages.chart],
    summary: '通过精准名单与电话开发，成功安排 15 场经销商会议，签约 3 家代理。',
    result: '渠道布局、代理签约',
    highlights: [
      { num: '15', label: '商务会议' },
      { num: '3', label: '代理签约' },
      { num: '越南/泰国', label: '市场落地' },
    ],
    ...
    sections: [
      ...
      { heading: '成果数据', items: ['成功安排 15 场与潜在经销商的视频会议', '客户亲自飞往当地拜访其中 5 家', '最终与 3 家签署代理合约，完成渠道布局'] },
      { heading: '关键价值', items: ['快速筛选优质合作伙伴', '大幅降低差旅与沟通成本', '建立稳固的售后服务网络'] },
    ],
  },
}
